...
randomisation_func <- function(site,pool){
  ...
  ## get the dispersal probailities of all the species in the sites species pool to the focal site
  
  dis_p <- dispersal_prob[site,sp_pool]
  
  ## relate dispersal probabilities to their species name
...
randomisations <- future_lapply(pred_sites,randomisation_func, pool = "0.9", future.seed = TRUE,future.label = TRUE)
...
Now we've imputed those missing traits - I don't know whether this is the best way to do it but we have it here. Or even whether this is feasaible. 
