...
refine_data <- refine_data %>% dplyr::mutate(Use_intensity = ifelse(SS == "DL1_2009__Azpiroz 1" & Predominant_habitat == "Cropland",
                                            ...
                                            Use_intensity = ifelse(SS == "SH1_2014__Walker 2",
                                                                   "Minimal use",paste(Use_intensity)),
                                            Use_intensity = ifelse(SS == "MJ1_2013__Ndanganga 1" & Predominant_habitat %in% c("Cropland","Pasture"),
                                                                   "Light use",paste(Use_intensity)),
                                            ...
                                            Use_intensity = ifelse(SS == "MJ1_2008__Munyekenye 1" & Predominant_habitat == "Secondary vegetation (indeterminate age)",
                                                                   "Minimal use",paste(Use_intensity)),
                                            Use_intensity = ifelse(SS == "DL1_2009__Azpiroz 1" & Predominant_habitat == "Pasture",
                                                                   "Light use",paste(Use_intensity)),
